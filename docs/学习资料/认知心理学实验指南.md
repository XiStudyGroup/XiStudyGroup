...
你需要分析的数据或许包括表格中的 `color`, `word`, `response2.corr` 以及 `response2.rt` 列。
...
你需要分析的数据或许包括表格中的 `isGo`, `responseTaskResponse.corr` 以及 `responseTaskResponse.rt` 列。
...
你需要分析的数据或许包括表格中的 `condition`, `posnerInput.corr` 以及 `posnerInput.rt` 列。
...
你需要分析的数据或许包括表格中的 `correct2`, `correct3`, `correct4`, `correct5`, `sound2`, `sound3`, `sound4`, `sound5`, `key_resp_16.corr`, `key_resp_16.rt`, `key_resp_19.corr`, `key_resp_19.rt`, `key_resp_6.corr`, `key_resp_6.rt`, `key_resp_13.corr` 以及 `key_resp_13.rt` 列。
...
你需要分析的数据或许包括表格中的 `Tonekind`（0 为 Background，1 为 Low，2 为 High）, `resp.corr` 以及 `resp.rt` 列。
